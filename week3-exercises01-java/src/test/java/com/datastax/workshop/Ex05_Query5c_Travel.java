...
public class Ex05_Query5c_Travel implements DataModelConstants {
    ...
    public static void initConnection() {
        ...
        cqlSession = CqlSession.builder().withCloudSecureConnectBundle(Paths.get(DBConnection.SECURE_CONNECT_BUNDLE))
    ...
    public void save_readings() throws InterruptedException {
        for (int i = 0; i < 50; i++) {
            ...
            journeyRepo.log(UUID.fromString(Ex04_Query5b_TakeOff.JOURNEY_ID), Ex04_Query5b_TakeOff.SPACECRAFT, speed,
                    pressure, temperature, x, y, z, readingTime);
            Thread.sleep(200);
